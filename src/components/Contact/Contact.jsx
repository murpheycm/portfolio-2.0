                ...
                <div className='bg-gradient-to-b from-orange-50 to-orange-200 shadow-black shadow-2xl text-center rounded-lg lg:w-auto'>
                    <div className="p-6">
                        ...
                        <form action="#contact" className="space-y-8" method='post'>
                            ...
                            <button type="submit" className="inline-block lg:mb-5 rounded-full shadow-2xl bg-fuchsia-500 px-6 pb-2 pt-2.5 text-lg text-white transition duration-200 ease-in hover:bg-violet-950">
                                Send
                            </button>
                        </form>
                    </div>
